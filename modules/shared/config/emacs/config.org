...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "hansgutmann"
    user-mail-address "hantaozhouted@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/hansgutmann/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/hansgutmann/bin" "/profile/bin" "/Users/hansgutmann/.npm-packages/bin" "/Users/hansgutmann/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
